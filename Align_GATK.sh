for i in {380..574}; do bwa mem -t 64 ../../reference/RKD/7D_peaks.fa ERR2219$i\_1_trimmed.fastq ERR2219$i\_2_trimmed.fastq > ../3_aligned/ERR2219$i.sam
...
../../programs/gatk-4.1.9.0/gatk HaplotypeCaller --reference ../../reference/RKD/7D_peaks.fa --input ERR2219$i\_dup_marked_add.bam --output ERR2219$i.vcf
